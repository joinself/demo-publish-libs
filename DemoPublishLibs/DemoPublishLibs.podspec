#
#  Be sure to run `pod spec lint DemoPublishLibs.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/joinself/demo-publish-libs.git", :branch => "main" }
  ...
  spec.source_files  = "DemoPublishLibs/**/*.{swift}"
